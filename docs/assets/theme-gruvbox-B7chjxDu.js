import{g as l}from"./index-DbiMS_WF.js";function i(o,c){for(var n=0;n<c.length;n++){const e=c[n];if(typeof e!="string"&&!Array.isArray(e)){for(const r in e)if(r!=="default"&&!(r in o)){const a=Object.getOwnPropertyDescriptor(e,r);a&&Object.defineProperty(o,r,a.get?a:{enumerable:!0,get:()=>e[r]})}}}return Object.freeze(Object.defineProperty(o,Symbol.toStringTag,{value:"Module"}))}var t={exports:{}},u;function s(){return u||(u=1,function(o,c){ace.define("ace/theme/gruvbox-css",["require","exports","module"],function(n,e,r){r.exports=`.ace-gruvbox .ace_gutter-active-line {
...
`}),ace.define("ace/theme/gruvbox",["require","exports","module","ace/theme/gruvbox-css","ace/lib/dom"],function(n,e,r){e.isDark=!0,e.cssClass="ace-gruvbox",e.cssText=n("./gruvbox-css");var a=n("../lib/dom");a.importCssString(e.cssText,e.cssClass,!1)}),function(){ace.require(["ace/theme/gruvbox"],function(n){o.exports=n})}()}(t)),t.exports}var g=s();const A=l(g),x=i({__proto__:null,default:A},[g]);export{x as t};
