...
`}),ace.define("ace/theme/gruvbox_dark_hard",["require","exports","module","ace/theme/gruvbox_dark_hard-css","ace/lib/dom"],function(a,r,e){r.isDark=!0,r.cssClass="ace-gruvbox-dark-hard",r.cssText=a("./gruvbox_dark_hard-css");var c=a("../lib/dom");c.importCssString(r.cssText,r.cssClass)}),function(){ace.require(["ace/theme/gruvbox_dark_hard"],function(a){n.exports=a})}()}(d)),d.exports}var b=g();const l=u(b),s=_({__proto__:null,default:l},[b]);export{s as t};
