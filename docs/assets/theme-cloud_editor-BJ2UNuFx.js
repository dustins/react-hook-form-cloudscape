...
`}),ace.define("ace/theme/cloud_editor",["require","exports","module","ace/theme/cloud_editor-css","ace/lib/dom"],function(o,e,c){e.isDark=!1,e.cssClass="ace-cloud_editor",e.cssText=o("./cloud_editor-css");var r=o("../lib/dom");r.importCssString(e.cssText,e.cssClass,!1)}),function(){ace.require(["ace/theme/cloud_editor"],function(o){n.exports=o})}()}(t)),t.exports}var l=u();const f=i(l),p=_({__proto__:null,default:f},[l]);export{p as t};
