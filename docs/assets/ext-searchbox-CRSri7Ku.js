import{g as w}from"./index-CU2Byj_S.js";function B(u,b){for(var i=0;i<b.length;i++){const h=b[i];if(typeof h!="string"&&!Array.isArray(h)){for(const p in h)if(p!=="default"&&!(p in u)){const r=Object.getOwnPropertyDescriptor(h,p);r&&Object.defineProperty(u,p,r.get?r:{enumerable:!0,get:()=>h[p]})}}}return Object.freeze(Object.defineProperty(u,Symbol.toStringTag,{value:"Module"}))}var _={exports:{}},A;function $(){return A||(A=1,function(u,b){ace.define("ace/ext/searchbox-css",["require","exports","module"],function(i,h,p){p.exports=`
