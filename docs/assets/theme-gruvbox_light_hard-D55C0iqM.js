...
`}),ace.define("ace/theme/gruvbox_light_hard",["require","exports","module","ace/theme/gruvbox_light_hard-css","ace/lib/dom"],function(r,e,a){e.isDark=!1,e.cssClass="ace-gruvbox-light-hard",e.cssText=r("./gruvbox_light_hard-css");var c=r("../lib/dom");c.importCssString(e.cssText,e.cssClass)}),function(){ace.require(["ace/theme/gruvbox_light_hard"],function(r){n.exports=r})}()}(t)),t.exports}var l=d();const u=h(l),_=i({__proto__:null,default:u},[l]);export{_ as t};
