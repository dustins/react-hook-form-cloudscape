...
`}),ace.define("ace/theme/xcode",["require","exports","module","ace/theme/xcode-css","ace/lib/dom"],function(c,e,n){e.isDark=!1,e.cssClass="ace-xcode",e.cssText=c("./xcode-css");var o=c("../lib/dom");o.importCssString(e.cssText,e.cssClass,!1)}),function(){ace.require(["ace/theme/xcode"],function(c){a.exports=c})}()}(t)),t.exports}var d=l();const x=s(d),_=i({__proto__:null,default:x},[d]);export{_ as t};
