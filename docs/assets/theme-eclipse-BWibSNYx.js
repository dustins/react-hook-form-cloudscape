...
`}),ace.define("ace/theme/eclipse",["require","exports","module","ace/theme/eclipse-css","ace/lib/dom"],function(c,e,n){e.isDark=!1,e.cssText=c("./eclipse-css"),e.cssClass="ace-eclipse";var r=c("../lib/dom");r.importCssString(e.cssText,e.cssClass,!1)}),function(){ace.require(["ace/theme/eclipse"],function(c){a.exports=c})}()}(i)),i.exports}var t=p();const g=s(t),d=A({__proto__:null,default:g},[t]);export{d as t};
