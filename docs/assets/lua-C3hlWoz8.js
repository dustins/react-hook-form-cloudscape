...
`}),ace.define("ace/snippets/lua",["require","exports","module","ace/snippets/lua.snippets"],function(t,e,n){e.snippetText=t("./lua.snippets"),e.scope="lua"}),function(){ace.require(["ace/snippets/lua"],function(t){r.exports=t})}()}(p)),p.exports}var a=l();const c=u(a),$=f({__proto__:null,default:c},[a]);export{$ as l};
