...
snippet docs (función con parámetros)
	/*
		...
		@TIPO: \${6:...}
	*/
`}),ace.define("ace/snippets/gobstones",["require","exports","module","ace/snippets/gobstones.snippets"],function(n,_,T){_.snippetText=n("./gobstones.snippets"),_.scope="gobstones"}),function(){ace.require(["ace/snippets/gobstones"],function(n){p.exports=n})}()}(K)),K.exports}var o=C();const i=F(o),s=r({__proto__:null,default:i},[o]);export{s as g};
