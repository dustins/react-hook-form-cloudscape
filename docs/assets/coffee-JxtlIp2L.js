...
snippet exp
	\${1:root} = exports ? this
`}),ace.define("ace/snippets/coffee",["require","exports","module","ace/snippets/coffee.snippets"],function(t,n,e){n.snippetText=t("./coffee.snippets"),n.scope="coffee"}),function(){ace.require(["ace/snippets/coffee"],function(t){s.exports=t})}()}(i)),i.exports}var c=$();const u=f(c),d=a({__proto__:null,default:u},[c]);export{d as c};
