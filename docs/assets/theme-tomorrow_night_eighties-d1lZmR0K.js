...
`}),ace.define("ace/theme/tomorrow_night_eighties",["require","exports","module","ace/theme/tomorrow_night_eighties-css","ace/lib/dom"],function(o,e,t){e.isDark=!0,e.cssClass="ace-tomorrow-night-eighties",e.cssText=o("./tomorrow_night_eighties-css");var r=o("../lib/dom");r.importCssString(e.cssText,e.cssClass,!1)}),function(){ace.require(["ace/theme/tomorrow_night_eighties"],function(o){n.exports=o})}()}(a)),a.exports}var g=m();const _=h(g),w=s({__proto__:null,default:_},[g]);export{w as t};
