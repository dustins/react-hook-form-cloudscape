import{g as o}from"./index-CU2Byj_S.js";function u(a,c){for(var t=0;t<c.length;t++){const e=c[t];if(typeof e!="string"&&!Array.isArray(e)){for(const n in e)if(n!=="default"&&!(n in a)){const l=Object.getOwnPropertyDescriptor(e,n);l&&Object.defineProperty(a,n,l.get?l:{enumerable:!0,get:()=>e[n]})}}}return Object.freeze(Object.defineProperty(a,Symbol.toStringTag,{value:"Module"}))}var i={exports:{}},r;function h(){return r||(r=1,function(a,c){ace.define("ace/theme/github_light_default-css",["require","exports","module"],function(t,e,n){n.exports=`.ace-github-light-default .ace_gutter {
    background: #ffffff;
...
`}),ace.define("ace/theme/github_light_default",["require","exports","module","ace/theme/github_light_default-css","ace/lib/dom"],function(t,e,n){e.isDark=!1,e.cssClass="ace-github-light-default",e.cssText=t("./github_light_default-css");var l=t("../lib/dom");l.importCssString(e.cssText,e.cssClass,!1)}),function(){ace.require(["ace/theme/github_light_default"],function(t){a.exports=t})}()}(i)),i.exports}var g=h();const d=o(g),A=u({__proto__:null,default:d},[g]);export{A as t};
