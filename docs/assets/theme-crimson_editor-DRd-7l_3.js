import{g as d}from"./index-DbiMS_WF.js";function m(o,a){for(var n=0;n<a.length;n++){const e=a[n];if(typeof e!="string"&&!Array.isArray(e)){for(const r in e)if(r!=="default"&&!(r in o)){const c=Object.getOwnPropertyDescriptor(e,r);c&&Object.defineProperty(o,r,c.get?c:{enumerable:!0,get:()=>e[r]})}}}return Object.freeze(Object.defineProperty(o,Symbol.toStringTag,{value:"Module"}))}var i={exports:{}},t;function A(){return t||(t=1,function(o,a){ace.define("ace/theme/crimson_editor-css",["require","exports","module"],function(n,e,r){r.exports=`.ace-crimson-editor .ace_gutter {
  background: #ebebeb;
  color: #333;
  overflow : hidden;
}
...
`}),ace.define("ace/theme/crimson_editor",["require","exports","module","ace/theme/crimson_editor-css","ace/lib/dom"],function(n,e,r){e.isDark=!1,e.cssText=n("./crimson_editor-css"),e.cssClass="ace-crimson-editor";var c=n("../lib/dom");c.importCssString(e.cssText,e.cssClass,!1)}),function(){ace.require(["ace/theme/crimson_editor"],function(n){o.exports=n})}()}(i)),i.exports}var s=A();const g=d(s),_=m({__proto__:null,default:g},[s]);export{_ as t};
