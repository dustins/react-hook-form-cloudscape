...
`),"commandbar.css",!1),p.CommandBarTooltip=A,p.TOOLTIP_CLASS_NAME=d,p.BUTTON_CLASS_NAME=a}),function(){ace.require(["ace/ext/command_bar"],function(c){_.exports=c})}()}(x)),x.exports}var I=U();const Y=W(I),z=B({__proto__:null,default:Y},[I]);export{z as e};
