...
`}),ace.define("ace/theme/gob",["require","exports","module","ace/theme/gob-css","ace/lib/dom"],function(n,e,a){e.isDark=!0,e.cssClass="ace-gob",e.cssText=n("./gob-css");var o=n("../lib/dom");o.importCssString(e.cssText,e.cssClass,!1)}),function(){ace.require(["ace/theme/gob"],function(n){c.exports=n})}()}(t)),t.exports}var b=s();const _=i(b),A=l({__proto__:null,default:_},[b]);export{A as t};
