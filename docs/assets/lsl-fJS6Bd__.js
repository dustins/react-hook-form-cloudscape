import{g as o}from"./index-DbiMS_WF.js";function $(l,i){for(var e=0;e<i.length;e++){const t=i[e];if(typeof t!="string"&&!Array.isArray(t)){for(const n in t)if(n!=="default"&&!(n in l)){const s=Object.getOwnPropertyDescriptor(t,n);s&&Object.defineProperty(l,n,s.get?s:{enumerable:!0,get:()=>t[n]})}}}return Object.freeze(Object.defineProperty(l,Symbol.toStringTag,{value:"Module"}))}var r={exports:{}},p;function g(){return p||(p=1,function(l,i){ace.define("ace/snippets/lsl.snippets",["require","exports","module"],function(e,t,n){n.exports=`snippet @
	@\${1:label};
...
`}),ace.define("ace/snippets/lsl",["require","exports","module","ace/snippets/lsl.snippets"],function(e,t,n){t.snippetText=e("./lsl.snippets"),t.scope="lsl"}),function(){ace.require(["ace/snippets/lsl"],function(e){l.exports=e})}()}(r)),r.exports}var a=g();const c=o(a),d=$({__proto__:null,default:c},[a]);export{d as l};
