...
`}),ace.define("ace/theme/twilight",["require","exports","module","ace/theme/twilight-css","ace/lib/dom"],function(n,e,t){e.isDark=!0,e.cssClass="ace-twilight",e.cssText=n("./twilight-css");var c=n("../lib/dom");c.importCssString(e.cssText,e.cssClass,!1)}),function(){ace.require(["ace/theme/twilight"],function(n){a.exports=n})}()}(r)),r.exports}var l=s();const A=g(l),w=h({__proto__:null,default:A},[l]);export{w as t};
