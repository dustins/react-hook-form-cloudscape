...
`}),ace.define("ace/theme/solarized_dark",["require","exports","module","ace/theme/solarized_dark-css","ace/lib/dom"],function(a,e,r){e.isDark=!0,e.cssClass="ace-solarized-dark",e.cssText=a("./solarized_dark-css");var c=a("../lib/dom");c.importCssString(e.cssText,e.cssClass,!1)}),function(){ace.require(["ace/theme/solarized_dark"],function(a){n.exports=a})}()}(d)),d.exports}var i=_();const k=l(i),u=s({__proto__:null,default:k},[i]);export{u as t};
