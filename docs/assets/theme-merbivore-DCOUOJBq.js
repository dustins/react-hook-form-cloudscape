...
`}),ace.define("ace/theme/merbivore",["require","exports","module","ace/theme/merbivore-css","ace/lib/dom"],function(r,e,n){e.isDark=!0,e.cssClass="ace-merbivore",e.cssText=r("./merbivore-css");var c=r("../lib/dom");c.importCssString(e.cssText,e.cssClass,!1)}),function(){ace.require(["ace/theme/merbivore"],function(r){a.exports=r})}()}(t)),t.exports}var m=l();const _=b(m),v=s({__proto__:null,default:_},[m]);export{v as t};
