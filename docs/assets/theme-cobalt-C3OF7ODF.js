...
`}),ace.define("ace/theme/cobalt",["require","exports","module","ace/theme/cobalt-css","ace/lib/dom"],function(a,e,c){e.isDark=!0,e.cssClass="ace-cobalt",e.cssText=a("./cobalt-css");var o=a("../lib/dom");o.importCssString(e.cssText,e.cssClass,!1)}),function(){ace.require(["ace/theme/cobalt"],function(a){n.exports=a})}()}(r)),r.exports}var b=g();const _=i(b),u=s({__proto__:null,default:_},[b]);export{u as t};
