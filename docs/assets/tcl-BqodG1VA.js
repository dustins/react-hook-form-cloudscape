...
snippet nsc
	namespace current
`}),ace.define("ace/snippets/tcl",["require","exports","module","ace/snippets/tcl.snippets"],function(n,t,e){t.snippetText=n("./tcl.snippets"),t.scope="tcl"}),function(){ace.require(["ace/snippets/tcl"],function(n){i.exports=n})}()}(p)),p.exports}var c=l();const $=a(c),d=f({__proto__:null,default:$},[c]);export{d as t};
