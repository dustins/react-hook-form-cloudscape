...
const CCodeEditor = (_a) => {
    ...
    return (React.createElement(Controller, { name: name, control: control, render: ({ field: { onChange, value } }) => (React.createElement(CodeEditor, Object.assign({ value: value || '', onChange: handleOnChange.bind(null, onChange) }, props))) }));
};
